 ...
 */
define('jsx.UIHeaderContainer', ['react','jsx.UIToolbars'], function(React,UIToolbars) {
	var UIHeaderContainer = {
		...
		createBack:function(){
			return <a href="javascript:;" className="btn btn-info tool tool-back" onClick={this.props.handles.onback}>
						<i className='glyphicon glyphicon-menu-left'></i>
					</a>;
		},
		createTitleContainer:function(){
			return <h3 className="center-block">{this.props.title}</h3>;
		},
		createToolbarContainer:function(){
			return <div className="tool tool-bar">{this.createToolbar()}</div>;
		},
