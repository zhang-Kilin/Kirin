	...
	var UISelectGroup = React.createClass({displayName: "UISelectGroup",
		...
		createToolbar:function(){
			if(this.props.toolbar){
				return React.createElement("div", {className: "toolbar"}, 
							...
							React.createElement("a", {href: "javascript:;", className: "btn btn-warning", onClick: this.ok}, "确定")
						);
			}
		},
		createBody:function(){
		...
		createItems:function(){
			...
			if(this.props.children){
				width = 1 / this.props.children.length;
				_.each(this.props.children,function(item){
					results.push(React.createElement("div", {className: "cell", style: {width:width+"%"}}, React.createElement(UISelect, {onchange: this.onitemchange}, item)))
				});
			}
			return results;
		},
