define('UIToolbars', ['react'], function(React) {
	...
	var moreMenuContainer = React.createClass({displayName: "moreMenuContainer",
		...
		render:function(){
			return React.createElement("a", {href: "javascript:;", className: "btn btn-info tool tool-btn moremenu-container", onClick: this.handle}, 
	...
	return _.extend(UIToolbars,{
		...
		createMenuList:function(props){
			...
			return React.createElement("moreMenuContainer", null, children);
		}
	});
});