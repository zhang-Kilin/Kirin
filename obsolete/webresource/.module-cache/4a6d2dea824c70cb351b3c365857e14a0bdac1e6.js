	...
	return React.createClass({
		...
		componentWillMount:function(){
			...
			var touchStart = 'ontouchstart' in document ? 'onTouchStart' : 'onMouseDown',
				...
				touchCancel = 'ontouchcancel' in document ? 'onTouchCancel' : 'onMouseOut',
				e = eval("({"+touchStart+":this.ontouchstart,"+touchMove+":this.ontouchmove,"+touchEnd+":this.ontouchend,"+touchCancel+":this.ontouchcancel})");
			this.setState({
				events:e
			});
		},
