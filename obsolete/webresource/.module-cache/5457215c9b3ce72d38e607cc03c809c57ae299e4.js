	...
	function createClass(propertys){
		return React.createClass({
			...
			createMoremenu:function(){
				return React.createElement("a", {href: "javascript:;", className: "btn btn-default", title: this.props.text, onClick: this.props.handle}, 
	...
	return _.extend(UIToolbars,{
		...
		create:function(props){
			switch(props.icon){
				...
				case 'share':
					return React.createElement(UIToolbars.share, React.__spread({},  props));
			}
		},
